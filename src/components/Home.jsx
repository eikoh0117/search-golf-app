...
class Home extends React.Component {
   state = { date: addDays(new Date(), 14), budget: '12000', departure: '1', duration: '90', plans: [], planCount: null, error: null, loading: false  }
  onFormSubmit = async (event) => {
    try {
      event.preventDefault();
      this.setState({ loading: true})

      const response = await axios.get('https://lrxby08ggl.execute-api.ap-northeast-1.amazonaws.com/production/golf-courses', {
